...
<template>
        ...
        <div class="flex flex-col w-full h-full relative">
            ...
            <div class=" flex flex-col gap-5">
                <div v-for="(shop, index) in shopList" :key="index" @click=goToShop(shop.id) class=" border rounded-[12px] bg-white p-2 shadow-md hover:shadow-md">
            ...
            <div class="flex justify-end absolute bottom-0 w-full p-5">
                <button class="bg-blue-500 text-white font-semibold rounded-[8px] px-2 py-1" @click="goToAddShop">ADD +</button>
            </div>
        </div>
